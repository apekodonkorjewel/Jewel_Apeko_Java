...
--customers with a ".org" email address.
select first_name ,last_name, phone
from northwind.customers c
where email like '%.org';

--List the first name, last name, and phone number for 
--all customers from the 202 area code.
select first_name, last_name, phone
from northwind.customers c
where phone like '%(202)%';

--List the first name, last name, and phone number for 
--all customers from the 202 area code, ordered 
