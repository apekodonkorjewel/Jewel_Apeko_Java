...
public class Customer {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(getCustomerId(), getLastName(), getFirstName(), getEmail(), getCompany(), getPhone(), getAddress1(), getAddress2(), getCity(), getState(), getPostalCode(), getCountry());
    }
